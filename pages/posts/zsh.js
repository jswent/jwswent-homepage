    ...
    <Layout title='ZSH'>
      <Container>
        ...
        <Section delay={0.1}>
          ...
          <P>
            When first launching a zsh terminal on macOS, you will be greeted
            with a prompt that looks like the one below. If you are on a Linux
            system and installed ZSH from your local package manager, you will
            likely see something even more stripped down.
          </P>

          <WorkImage src='/images/posts/zsh/termInit.png' alt='termInit' />
          <P>
            By default, ZSH has no built-in configuration options (macOS
            includes a few), so we will have to enable logging, colors, and
            completion by ourselves. Let&apos;s start with the basics:
          </P>
        </Section>
        ...
        <Section delay={0.2}>
          ...
          <P>
            ...
            configuration files, as I prefer to minimize the amount of dotfiles
            in my home directory. To achieve this we will create the ~/.zsh
            directory, and symlink ~/.zsh/.zshrc to ~/.zshrc.
          </P>
          <WorkImage
            src='/images/posts/zsh/zshDirSetup.png'
            alt='zshDirSetup'
          />
        </Section>
        ...
        <Section delay={0.3}>
          ...
          <P>
            ...
            will require the --color flag to be explicity specified. To fix
            this, we will create a new ~/.zsh/aliases file that will contain
            aliases specifying colored output. Note that this is not required on
            macOS systems.
          </P>
          <Box p='1' opacity='0' />
        ...
        <Section delay={0.5}>
          ...
          <P>
            ...
            manually installing them require barely an extra line in your
            .zshrc. Simply create a plugins directory and clone the desired
            repos. If you&apos;re interested on how to create a lightweight
            plugin manager that can automatically source OMZ plugins, view my
            article{' '}
            <Link href='/posts/zpm'>
          ...
          <P>
            And now just source the specified files in your zsh config file.
          </P>
          <Box p='1' opacity='0' />
          <Meta>~/.zshrc</Meta>
          <Box p='1' opacity='0' />
